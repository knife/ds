...
More: http://en.wikipedia.org/wiki/Stack_(abstract_data_type)
...
More: http://en.wikipedia.org/wiki/Queue_(data_structure)
...
More: http://en.wikipedia.org/wiki/Priority_queue
...
More: http://en.wikipedia.org/wiki/List_(data_structure)
...
More: http://en.wikipedia.org/wiki/Ring_(data_structure)
...
More: http://en.wikipedia.org/wiki/Tree_(data_structure)
...
More: http://en.wikipedia.org/wiki/Binary_tree 
...
internally in array.
More: http://en.wikipedia.org/wiki/Complete_binary_tree
...
More: http://en.wikipedia.org/wiki/Binary_heap
...
vertices.
More: http://en.wikipedia.org/wiki/Graph_(data_structure)
