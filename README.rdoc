...
DS provides some common data structures not implemented in Ruby natively.
...
of PriorityQueue is the same as SimpleQueue.
...
Graph consist of vertices connected with edges. There are many types of graphs:
sparse, dense, directed, undirected, weighted and more...
