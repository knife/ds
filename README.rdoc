...
Comparable module is included:

Checking if lists are equal
  list1 == list2

Checking if one list is greater than other (same rules as in Array class)
  list1 > list2
...
A tree is a data structure where nodes are organised in hierarchy.
